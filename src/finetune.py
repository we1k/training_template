...
def main():
    ...
    if args.use_lora:
        ...
        # finetune only the embed_tokens module
        # or "q_proj", "v_proj" for llama2
    ...
    with accelerator.main_process_first():
        if os.path.exists("lm_dataset.hf"):
            logger.info("Loading cached processed data from lm_dataset.hf")
            lm_datasets = datasets.load_from_disk("lm_dataset.hf")
        else:
            ...
            lm_datasets.save_to_disk("lm_dataset.hf")
    ...
    logger.info("loading data to Dataloader")
